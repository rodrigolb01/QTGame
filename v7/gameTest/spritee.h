...
//works similiar to player controlled sprite entity, but this one is controlled by algorithms
class spriteE: public QObject, public QGraphicsItem
{
    Q_OBJECT
public:
    explicit spriteE(QObject *parent=0);
    void move();
    void shoot();
    void slash();
